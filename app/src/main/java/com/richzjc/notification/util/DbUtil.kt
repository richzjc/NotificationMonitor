...
import com.richzjc.notification.service.MyNotificationListenerService.dbHelper
...
fun insert(dbHelpter : DataBaseHelper, entity : NotificationEntity){
    ...
    val cursor = dbHelper.writableDatabase.query("notification", null, null, null, null, null, null)
